...
echo "<b>Bruger</b> - ";
echo "<a href='https://wits.ruc.dk/~stud-madd/WITSocial/postList.php?uid=$input'>"; // Gør efterfølgende tekst til link til postList.
...
foreach ($posts as $pid){ // Tager posts array og laver ny variable pid for hver iteration.
    ...
    echo "- ";
    echo "<a href='https://wits.ruc.dk/~stud-madd/WITSocial/post.php?pid=$pid'>"; // Gør efterfølgende tekst til link til post.
